<?php
	...
	function keira_fonts_url() {
		...
		if ( 'off' !== _x( 'on', 'Google font: on or off', 'keira' ) ) {
			$font_url = add_query_arg( 'family', urlencode( 'Nunito|Saira:100,200,200i,300,300i,400,400i,500,600,600i,700,700i,800,800i,900,900i&display=swap' ), "//fonts.googleapis.com/css" );
		}
